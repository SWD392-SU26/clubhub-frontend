  ...
  return (
    <Routes>
      ...
      <Route element={<AdminLayout />}>
        ...
        <Route path="/club-admin/members/:id" element={<MemberDetailPage />} />
        <Route
          path="/club-admin/join-requests"
          element={<ClubJoinRequestsAdminPage />}
        />
        <Route path="/club-admin/events" element={<EventsManagementPage />} />
        <Route path="/club-admin/events/new" element={<CreateEventPage />} />
        <Route path="/club-admin/events/cancel" element={<CancelEventPage />} />
        <Route
        ...
        />
        <Route path="/club-admin/points" element={<PointsManagementPage />} />
        <Route path="/club-admin/statistics" element={<ClubStatisticsPage />} />
